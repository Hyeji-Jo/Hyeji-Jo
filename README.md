...
| Title | Date  | Etc |
|:-----:	|:----------:	|:-------:|
| 데이턴십 해커톤 제4회 참여 | `2021` | '서울시 복지 불균형 완화를 위한 노인복지시설 종류별 최적 입지 분석' |
| 체육종합 데이터 활용 경진대회 참여 | `2020` | '경륜 데이터를 활용한 경륜 선수 분석 플랫폼' |
| 데이터 활용 아이디어 공모전 본선 진출 | `2020` | '유동인구에 따른 전기차 충전소 확충 및 개선' |
